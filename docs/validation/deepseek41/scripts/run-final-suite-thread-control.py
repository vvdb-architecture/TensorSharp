...
p=argparse.ArgumentParser();p.add_argument('profile');p.add_argument('--phase',choices=['quality','steady','decode8k','long','long-parallel','protocol','placement','tools','multilingual','media','thread-control'],default='quality');a=p.parse_args();w=pathlib.Path('/workspace/deepseek41-work')
