...
| iOS application | TensorAgent targets iOS/iPadOS, links GGML as an iOS `.xcframework`, and uses `ggml_metal` on physical devices. It shares the host-neutral chat pipeline; see [TensorAgent](TensorAgent/README.md). |
